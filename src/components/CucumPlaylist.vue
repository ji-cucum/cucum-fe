  ...
  <div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col gap-8">
      <div>
        <button
          type="button"
          class="w-full bg-gray-800 p-2 rounded-full"
          @click="
            () => {
      ...
      <div class="flex flex-col gap-2 h-90 overflow-y-scroll">
        <div :key="i" v-for="(playlist, i) of playlists" class="group">
          <button
            type="button"
            class="flex items-center justify-between w-full bg-gray-800 p-4 rounded-lg relative"
          >
            <div class="flex flex-col w-full justify-between items-start">
              <div class="flex w-full">
                ...
                <div class="flex flex-col text-left w-2/3 items-start justify-center">
                  <div class="font-bold text-2xl text-ellipsis text-nowrap overflow-hidden w-60">
                    {{ playlist.name }}
                  </div>
                  <div class="text-gray-500 text-ellipsis text-nowrap overflow-hidden w-60">
            ...
            <div
              class="absolute hidden group-hover:block top-0 left-0 w-full h-full z-50 bg-indigo-500 bg-opacity-25 p-4"
            >
          ...
          <button @click="generateQRCode(playlist.id)">QRコード共有</button>
