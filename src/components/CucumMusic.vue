<template>
  <div class="flex flex-col gap-6" >
    <div class="flex flex-col gap-8">
      <div class="flex flex-col gap-2 pt-2 overflow-y-scroll h-82">
        ...
        <footer>
          ...
          <div v-show="paging.showLoader" role="status" class="flex justify-center pt-1 h-14">
...
export default {
  ...
  methods: {
    ...
    loadPlayer(music) {
      this.globalVideo.videoId = music.third_party_key
    }
  },
  data() {
    return {
