    ...
    <div class="relative mt-4 bg-white shadow-md sm:rounded-lg text-left">
      ...
      <div class="py-6 px-6">
        <div class="flex items-center justify-center ">
          <button class="flex-grow px-11 py-2 border flex gap-2 border-slate-500 rounded-lg text-black hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150">
